...
<div class="mdl-grid" style="padding: 2px 0px 0px 0px;" ng-show="visibilty">
    ...
    <div class="mdl-card mdl-shadow--6dp">
        ...
        <div class="mdl-card__supporting-text" >
            <form autocomplete="false" name="userForm"  ng-submit="checkUser()" method="post">
                <div class="mdl-textfield mdl-js-textfield left-inner-addon">
                    <i class="material-icons">&#xE7FF;</i>
                    <input class="mdl-textfield__input element-space" type="text" id="username" name="userEmail" autocomplete="off" value="" ng-model="User.userEmail"/>
                    <label class="mdl-textfield__label element-space" for="username">Useremail</label>
                </div><br>
                <div class="mdl-textfield mdl-js-textfield left-inner-addon">
                    <i class="material-icons">&#xE897;</i>
                    <input class="mdl-textfield__input element-space" type="{{inputType}}" id="userpass" value=""  ng-model="User.userPassword" name="userPassword" />
                    <label class="mdl-textfield__label element-space" for="userpass" autocomplete="off">Password</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield left-inner-addon">
